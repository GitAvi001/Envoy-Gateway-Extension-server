...
// 	// +kubebuilder:validation:Enum=REST;GraphQL;GRPC;Websocket;SSE
...
func (src *API) ConvertTo(dstRaw conversion.Hub) error {
	...
	// v1alpha3 has an Environment field, which v1alpha1 does not. Ignore it during conversion to hub.
